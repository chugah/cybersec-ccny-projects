This Q# project runs a simulation the BB84 protocol without an eavesdropper. It is based on [Microsoft's quantum katas](https://quantum.microsoft.com/en-us/experience/quantum-katas).
